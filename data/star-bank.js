/* Pre-written STAR answers for Anuvik Thota's resume bullets.
   Add new entries any time — the app picks them up automatically.
   `tags` drive filtering/search; use whatever labels are useful. */

const STAR_BANK = [
  {
    role: "MSRcosmos · AI Forward Deployed SWE Intern",
    ...
    tags: ["agents", "langgraph", "aws", "ownership", "system-design"]
  },
  {
    role: "MSRcosmos · AI Forward Deployed SWE Intern",
    ...
    tags: ["agents", "data-integrity", "reliability", "ambiguity"]
  },
  {
    role: "MSRcosmos · AI Forward Deployed SWE Intern",
    ...
    tags: ["agents", "mcp", "ownership", "solo-project", "speed"]
  },
  {
    role: "USC · AI/ML Research Intern",
  ...
  },
  {
    ...
    tags: ["ml", "performance", "profiling", "deep-dive"]
  },
  {
    role: "USC · AI/ML Research Intern",
    ...
    tags: ["backend", "sql", "impact", "tooling"]
  },
  {
    role: "Oracle · Software Engineer II",
    ...
    tags: ["observability", "sre", "scale", "impact"]
  },
  {
    role: "Oracle · Software Engineer II",
    ...
    tags: ["observability", "on-call", "scale", "automation"]
  },
  {
    role: "Oracle · Software Engineer II",
    ...
    tags: ["sql", "performance", "deep-dive", "debugging"]
  },
  {
    role: "Oracle · Software Engineer II",
    ...
    tags: ["devops", "ci-cd", "cross-team", "leadership", "impact"]
  },
  {
    role: "Oracle · Software Engineer II",
    ...
    tags: ["devops", "kubernetes", "cost", "scale"]
  },
  {
    role: "Project · ModelScope",
    ...
    tags: ["ml", "llm", "quantization", "personal-project", "deep-dive"]
  },
  {
    role: "Project · ModelScope",
    ...
    tags: ["ml", "llm", "analysis", "personal-project"]
  },
  {
    role: "Project · GNN Fraud Detection",
    ...
    tags: ["ml", "gnn", "personal-project", "deep-dive"]
  },
  {
    role: "Project · GNN Fraud Detection",
    ...
    tags: ["ml", "gnn", "data-modeling", "personal-project"]
  }
];
